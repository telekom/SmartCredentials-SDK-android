...
/**
 * Communication pipeline between the calling app and the SDK's authentication service.
 * <p>
...
public interface AuthenticationService {
     ...
     */
    @SuppressWarnings("unused")
    void login(Context context, Intent completionIntent, Intent cancelIntent);
     ...
     */
    @SuppressWarnings("unused")
    void refreshAccessToken(TokenRefreshListener listener);

    /**
     * Performs an authorized action with a fresh access token.
     */
    @SuppressWarnings("unused")
    void performActionWithFreshTokens(OnFreshTokensRetrievedListener listener);
