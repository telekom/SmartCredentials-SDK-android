...
public enum SmartCredentialsFeatureSet {
    ...
    CARRIER_CONFIGURATION("Carrier Configuration", SmartCredentialsModuleSet.CARRIER_CONFIGURATION_MODULE,
            "The Carrier Configuration feature is not supported on this device model."),
