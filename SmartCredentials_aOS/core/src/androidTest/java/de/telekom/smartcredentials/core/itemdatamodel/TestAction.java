...
/**
 * Created by Lucian Iacob on December 13, 2018.
 */
public class TestAction extends SmartCredentialsAction implements Serializable {

    TestAction(String id, String name, JSONObject data) {
        super(id, name, data);
    }
