...
package de.telekom.smartcredentials.camera.barcode.utils;
...
public class RectComparator {
    ...
    public static boolean isBarcodeInBounds(Barcode element, float left, float top, float right,
                                            float bottom, RectAdjuster rectAdjuster) {
