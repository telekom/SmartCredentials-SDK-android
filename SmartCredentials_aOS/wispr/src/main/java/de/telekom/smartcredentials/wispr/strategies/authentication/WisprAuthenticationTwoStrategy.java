...
public class WisprAuthenticationTwoStrategy extends WisprAuthenticationStrategy {

    public WisprAuthenticationTwoStrategy(WisprAuthenticationCallback authenticationCallback) {
