...
public class SmartWisprAuthenticationReply implements WisprAuthenticationReply {

    private static final String PATH = "AuthenticationReply";
    ...
    private int mMaxSessionTime;

    @Path(PATH)
    @Element(name = "LoginResultsURL", required = false)
    private String mLoginResultUrl;
    ...
    public String getLoginResultUrl() {
        return mLoginResultUrl;
    }

    public int getMaxSessionTime() {
        return mMaxSessionTime;
    }
    ...
    public String toString() {
        return "SmartWisprAuthenticationReply{" +
                "mMessageType=" + mMessageType +
                ", mResponseCode=" + mResponseCode +
                ", mLogoffUrl='" + mLogoffUrl + '\'' +
                ", mMaxSessionTime=" + mMaxSessionTime +
                ", mLoginResultUrl='" + mLoginResultUrl + '\'' +
                ", mStatusUrl='" + mStatusUrl + '\'' +
                ", mReplyMessage='" + mReplyMessage + '\'' +
