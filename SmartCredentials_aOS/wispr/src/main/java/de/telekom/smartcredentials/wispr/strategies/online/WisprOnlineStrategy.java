...
public abstract class WisprOnlineStrategy {

    protected WisprRedirectCallback mRedirectCallback;

    public WisprOnlineStrategy(WisprRedirectCallback redirectCallback) {
        mRedirectCallback = redirectCallback;
    }

    public abstract WisprRedirectReply checkOnline(WisprService wisprService, String url) throws IOException, WisprException;
}
