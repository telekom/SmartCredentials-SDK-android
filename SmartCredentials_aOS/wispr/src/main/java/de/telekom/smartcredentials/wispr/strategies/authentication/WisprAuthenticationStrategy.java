...
public abstract class WisprAuthenticationStrategy {

    protected WisprAuthenticationCallback mAuthenticationCallback;

    public WisprAuthenticationStrategy(WisprAuthenticationCallback authenticationCallback) {
        mAuthenticationCallback = authenticationCallback;
    }

    public abstract String login(WisprService wisprService, String url, String username, String password,
