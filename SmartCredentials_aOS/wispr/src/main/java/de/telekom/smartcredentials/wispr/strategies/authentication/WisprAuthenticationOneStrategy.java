...
public class WisprAuthenticationOneStrategy extends WisprAuthenticationStrategy {

    public WisprAuthenticationOneStrategy(WisprAuthenticationCallback authenticationCallback) {
    ...
    public String login(WisprService wisprService, String url, String username, String password,
        ...
        return wisprService.login(url, username, password, loginParameters).execute().body();
    }
}
