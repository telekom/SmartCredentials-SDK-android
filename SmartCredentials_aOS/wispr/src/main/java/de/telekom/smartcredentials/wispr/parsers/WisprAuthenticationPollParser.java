...
import de.telekom.smartcredentials.wispr.replies.SmartWisprAuthenticationPollReply;

public class WisprAuthenticationPollParser implements WisprAuthenticationParser {

    private WisprAuthenticationCallback mAuthenticationCallback;

    public WisprAuthenticationPollParser(WisprAuthenticationCallback authenticationCallback) {
        mAuthenticationCallback = authenticationCallback;
    }

    @Override
    public SmartWisprAuthenticationPollReply parse(String body) throws WisprException {
        ...
        SmartWisprAuthenticationPollReply authenticationPollReply;
        try {
            authenticationPollReply = serializer.read(SmartWisprAuthenticationPollReply.class, xml, false);
        } catch (Exception e) {
