 ...
 */
public class TokenRefreshedObservable implements ObservableOnSubscribe<String> {

    private final PushNotificationsController mController;

    public TokenRefreshedObservable(PushNotificationsController controller) {
        mController = controller;
    }

    @Override
    public void subscribe(ObservableEmitter<String> emitter) {
        mController.setTokenRefreshedCallback(emitter::onNext);
    }
}
