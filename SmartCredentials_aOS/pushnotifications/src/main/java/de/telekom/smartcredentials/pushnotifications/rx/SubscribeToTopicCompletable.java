 ...
 */
public class SubscribeToTopicCompletable implements CompletableOnSubscribe {

    private final PushNotificationsController mController;
    private final String mTopic;

    public SubscribeToTopicCompletable(PushNotificationsController controller, String topic) {
    ...
    public void subscribe(CompletableEmitter emitter) {
        mController.subscribeToTopic(mTopic, new PushNotificationsCallback() {
            @Override
