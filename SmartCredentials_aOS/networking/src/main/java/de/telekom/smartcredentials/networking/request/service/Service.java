...
package de.telekom.smartcredentials.networking.request.service;
...
public interface Service {
    ...
    void prepareSocketFactory(Context context, ConnectionType connectionType, SocketFactoryCallback socketFactoryCallback);

    void createRequest(RequestParams requestParams, ServicePluginCallback servicePluginCallback);
}
