...
public class SlovakiaCombinedResult extends CombinedResult {
    ...
    public SlovakiaCombinedResult(Recognizer.Result.State resultState) {
        super(resultState);
    }
    ...
    public SlovakiaCombinedResult setSpecialRemarks(String specialRemarks) {
    ...
    public SlovakiaCombinedResult setSurnameAtBirth(String surnameAtBirth) {
    ...
    public SlovakiaCombinedResult setPersonalIdentificationNumber(String personalIdentificationNumber) {
    ...
    public SlovakiaCombinedResult setDocumentNumber(String documentNumber) {
    ...
    public SlovakiaCombinedResult setFirstName(String firstName) {
    ...
    public SlovakiaCombinedResult setLastName(String lastName) {
        mLastName = lastName;
        return this;
    }
    ...
    public SlovakiaCombinedResult setSex(String sex) {
        mSex = sex;
        return this;
    }
    ...
    public SlovakiaCombinedResult setTitle(String title) {
        mTitle = title;
        return this;
    }
    ...
    public SlovakiaCombinedResult setAddress(String address) {
        mAddress = address;
        return this;
    }
    ...
    public SlovakiaCombinedResult setIssuingAuthority(String issuingAuthority) {
    ...
    public SlovakiaCombinedResult setNationality(String nationality) {
    ...
    public SlovakiaCombinedResult setPlaceOfBirth(String placeOfBirth) {
    ...
    public SlovakiaCombinedResult setDateOfBirth(Date dateOfBirth) {
    ...
    public SlovakiaCombinedResult setDateOfExpiry(Date dateOfExpiry) {
    ...
    public SlovakiaCombinedResult setDateOfIssue(Date dateOfIssue) {
    ...
    public SlovakiaCombinedResult setEncodedSignatureImage(byte[] encodedSignatureImage) {
    ...
    public SlovakiaCombinedResult setMrzVerified(boolean mrzVerified) {
