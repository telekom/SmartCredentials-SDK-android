 ...
 */
public class BindRx2Completable implements CompletableOnSubscribe {

    private final Context context;
    private final String appPackage;
    private final EidController eidController;

    public BindRx2Completable(Context context, String appPackage, EidController eidController) {
