 ...
 */
public class BindRx3Completable implements CompletableOnSubscribe {

    private final Context context;
    private final String appPackage;
    private final EidController eidController;

    public BindRx3Completable(Context context, String appPackage, EidController eidController) {
    ...
    public void subscribe(@NonNull CompletableEmitter emitter) {
        eidController.bind(context, appPackage);
        emitter.onComplete();
    }
}
