 ...
 */
public class SessionGeneratedMessage extends SmartEidMessage {

    private String mSessionId;

    public SessionGeneratedMessage(String sessionId) {
        super(EidMessageType.SESSION_GENERATED.getMessageType());
