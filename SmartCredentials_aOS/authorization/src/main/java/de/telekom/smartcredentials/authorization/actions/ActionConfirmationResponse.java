...
public class ActionConfirmationResponse {
    ...
    public ActionConfirmationResponse(boolean response, String desc, ConfirmationType type) {
        mResponse = response;
        mDescription = desc;
        mConfirmationType = type;
    }

    public ActionConfirmationResponse(String desc) {
        mDescription = desc;
    }
