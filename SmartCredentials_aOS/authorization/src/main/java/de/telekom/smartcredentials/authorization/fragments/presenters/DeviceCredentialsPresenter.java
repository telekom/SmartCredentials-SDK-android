...
public class DeviceCredentialsPresenter extends AlternativeAuthHandler {

    public DeviceCredentialsPresenter(KeyguardManagerWrapper keyguardManagerWrapper) {
        super(keyguardManagerWrapper);
    }

    public void viewReady(AlternativeAuthView view, AuthorizationPluginCallback pluginCallback) {
        super.viewReady(view, pluginCallback);
